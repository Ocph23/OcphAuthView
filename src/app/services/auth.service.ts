...
export class AuthService {
  ...
  async me() {
    try {
      var result = await this.http.get<any>("http://localhost:3000/auth/me",this.getHttpHeader()).toPromise();
      return result;
     } catch (err) {
  ...
  async updateProfile(model) {
    try {
      var result = await this.http.put<any>("http://localhost:3000/auth/profile",
      model,this.getHttpHeader()).toPromise();
      return result;
     } catch (err) {
       throw new Error(err.error.message);
     }
  ...
  async register(model: any) {
    try {
      var result = await this.http.post<any>("http://localhost:3000/register/create",
      model,this.getHttpHeader()).toPromise();
      return result;
     } catch (err) {
       throw new Error(err.error.message);
 ...
 async login(model: any) {
   try {
    var result = await this.http.post<any>("http://localhost:3000/auth/login",
    model,this.getHttpHeader()).toPromise();
    this.storage.addObject('user', result);
    return result;
   } catch (err) {
     throw new Error(err.error.message);
   }
